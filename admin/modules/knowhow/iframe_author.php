...
if (isset($_POST['remove'])) {
    ...
    $sql_op->delete('knowhow_author', 'author_id='.$id.' AND biblio_id='.$bid);
    echo '<script type="text/javascript">';
...
if ($biblioID) {
    ...
    // database list
    $biblio_author_q = $dbs->query("SELECT ba.*, a.author_name FROM knowhow_author AS ba
        LEFT JOIN mst_author AS a ON ba.author_id=a.author_id
        WHERE ba.biblio_id=$biblioID ORDER BY ba.level ASC");
